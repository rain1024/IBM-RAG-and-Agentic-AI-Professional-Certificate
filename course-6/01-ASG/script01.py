"""
Simple AI Agent Demo with LangChain
================================================================================
...
DESCRIPTION:
    This module implements a simple AI agent using LangChain.
    The agent can use tools like calculator and search, and have conversations.
"""
...
def run_simple_demo():
    """Run the simple AI agent demo"""
    print("\n" + "="*50)
    print("Simple AI Agent Demo with LangChain")
    print("="*50)
